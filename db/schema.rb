...
ActiveRecord::Schema[8.1].define(version: 2026_09_23_000011) do
  ...
  create_table "roles", force: :cascade do |t|
    ...
    t.string "name", null: false
    t.datetime "updated_at", null: false
    t.index "account_id, lower((name)::text)", name: "index_roles_on_account_id_and_lower_name", unique: true
